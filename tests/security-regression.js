...
assert(deploy.includes('profisport-1c-auto-v1:${PROFISPORT_DB_PASSWORD}'));
assert(deploy.includes('sha256sum'));
assert(deploy.includes("'migration_key' => base64_decode('${MIGRATION_B64}', true)"));
