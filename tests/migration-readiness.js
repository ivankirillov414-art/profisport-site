...
assert.match(tickWorkflow,/aes\.js/,'scheduled worker must recognize the InfinityFree browser challenge');
assert.match(tickWorkflow,/same-origin storefront traffic remains the authorized fallback trigger/,'challenge handling must explicitly defer to the browser fallback');
