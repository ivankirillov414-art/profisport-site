...
$v=validate_order($input);check($v['phone']==='+79991234567','normalized phone');check($v['groups']===[1=>2],'quantities');check($v['bonus_spend']===0,'default bonus spend');
...
fails(fn()=>validate_order(array_replace($input,['bonus_spend'=>-1])),'invalid_bonus_spend');
